...
func NewDb() (*Db, error) {
	...
	_, r = db.Exec(`
		...
		BEGIN TRANSACTION;
			...
			INSERT INTO TASKS ( LIST, TITLE, CREATED, FOR, BODY) VALUES( "todo",'OUSSAMA', DATETIME('2024-12-25 19:00:00'), DATETIME('2024-12-25'), 'OUSSAMA');
			INSERT INTO TASKS ( LIST, TITLE, CREATED, FOR, BODY) VALUES( "todo",'RAYANE', DATETIME('2024-12-25 19:00:00'), DATETIME('2024-12-25'), 'OUSSAMA');
			INSERT INTO TASKS ( LIST, TITLE, CREATED, FOR, BODY) VALUES( "todo",'SIMO', DATETIME('2024-12-25 19:00:00'), DATETIME('2024-12-25'), 'OUSSAMA');
		COMMIT;
	`)
